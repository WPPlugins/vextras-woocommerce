...
**Integrations and messaging designed for WooCommerce retailers**

Vextras allows WooCommerce retailers to send targeted e-mails based on customer behavior like abandoned carts, customer reviews, rewards and much more. In addition, shop owners can sync their online store with software they depend on to run their businesses.

**Workflows**

*Targeted e-mail messaging for WooCommerce that will create sales & save time*

Trigger [abandoned cart](https://www.vextras.com/workflows/abandoned-carts) emails, [first-time buyer](https://www.vextras.com/workflows/first-time-buyers) messages, [customer reminders](https://www.vextras.com/workflows/customer-retention), [order status updates](https://www.vextras.com/workflows/order-updates) and more from our pre-built [workflows](https://www.vextras.com/workflows). Target your customers when it matters the most in one simple, easy-to-use rule builder.

* Inject [dynamic data](https://www.vextras.com/docs/workflows/#woocommerce) from your store to create relevant, personalized emails.
...
*Sync your WooCommerce store with software you already use*

Every [app integration](https://www.vextras.com/apps) we've built goes far beyond a typical plugin. From the start we've created powerful, automated connections with the online retailer in mind. Now, you can connect with great cloud software like [MailChimp](https://www.vextras.com/apps/mailchimp), [Xero](https://www.vextras.com/apps/xero), and [Slack](https://www.vextras.com/apps/slack) in just a few clicks.
...
Getting going with the Vextras plugin is simple. Follow these steps to connect your store with Vextras in just a few minutes.
...
1. Enable the REST API by following [these instructions](https://docs.woothemes.com/document/woocommerce-rest-api/)
...
1. [Download](https://wordpress.org/plugins/vextras-woocommerce/) and activate the Vextras plugin. You may also download it inside of Vextras if you have an account with us already (+ Add New > Store > WooCommerce)
1. After activation of the plugin, login with your existing Vextras username and password or create a new account with us inside of Wordpress.
1. Once you're connected, login to your [Vextras account](https://app.vextras.com/auth/login) and add any [app](https://www.vextras.com/docs/vextras-account-information/#apps) or [workflow](https://www.vextras.com/docs/vextras-account-information/#workflows).
...
* We provide a free trial of our service for 30 days. During this time you will have access to the Professional plan and all of its features. After this trial period is over, a paid subscription is required to use any of our tools.
* After activation, apply plugin updates just as you normally would with any other plugin.
* All configuration of apps and workflows will occur in your Vextras dashboard.

== Screenshots ==

1. Login or create an account inside Wordpress
2. Add a new app in Vextras and sync your store with software you already use to run your business
3. Add a workflow in Vextras to automate customer communications, win back business, deliver digital downloads and much more
4. See your store's performance from a high level with beautiful dashboard overviews
5. Visualize app activities and dive deeper into individual log events
6. See how your e-mail workflows are performing with delivery and creating sales
7. View order details and helpful information about the transaction
8. See individual customer metrics including frequency of purchase, historical sales, top products bought and more
